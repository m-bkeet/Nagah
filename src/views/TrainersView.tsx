...
بالتوفيق دائماً 🌟`;
  ...
  return (
    <div className="space-y-5">
      {/* Header */}
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white dark:bg-slate-850 border border-slate-200 dark:border-slate-800 p-4 rounded-2xl shadow-xs dark:shadow-md backdrop-blur-md">
        <div>
          <h2 className="text-lg font-black text-slate-900 dark:text-slate-100 flex items-center gap-2">
            <GraduationCap className="w-5 h-5 text-blue-500 dark:text-blue-400" />
            إدارة المدربين ومستحقاتهم المالية
            <span className="text-xs bg-blue-50 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-500/30 px-2 py-0.5 rounded-full font-mono font-bold">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <select
            ...
            className="bg-white dark:bg-slate-900 border border-amber-300 dark:border-amber-500/40 rounded-xl px-3 py-2 text-xs text-amber-800 dark:text-amber-300 focus:outline-none focus:ring-2 focus:ring-amber-500/20 font-bold"
          ...
          <div className="relative">
            ...
            <input
              ...
              className="bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl pr-9 pl-3 py-2 text-xs text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20"
            />
          </div>

          <button
            onClick={() => { setActiveTrainer(null); setIsTrainerPortalModalOpen(true); }}
            className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-500 hover:to-blue-500 text-white font-black text-xs shadow-md shadow-indigo-600/20 transition-all cursor-pointer"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-amber-50 dark:bg-amber-500/20 hover:bg-amber-100 dark:hover:bg-amber-500/30 text-amber-800 dark:text-amber-300 font-bold text-xs border border-amber-200 dark:border-amber-500/40 shadow-xs transition-all cursor-pointer"
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-100 font-bold text-xs shadow-xs transition-all border border-slate-200 dark:border-slate-700 cursor-pointer"
          >
      ...
      <div className="bg-gradient-to-r from-indigo-50 via-white to-blue-50 dark:from-indigo-950/80 dark:via-slate-900 dark:to-blue-950/80 border border-indigo-200 dark:border-indigo-500/40 rounded-2xl p-4 shadow-xs dark:shadow-xl backdrop-blur-md">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-indigo-500 to-blue-600 flex items-center justify-center text-white shadow-md shadow-indigo-500/25 shrink-0">
              <GraduationCap className="w-6 h-6" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <h3 className="text-base font-black text-slate-900 dark:text-slate-100">بوابة المدرب الذكية (PWA & Web)</h3>
                <span className="text-[10px] bg-indigo-100 dark:bg-indigo-500/20 text-indigo-800 dark:text-indigo-300 px-2.5 py-0.5 rounded-full font-bold border border-indigo-200 dark:border-indigo-500/30">
          ...
          <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
            <button
              ...
              className="flex-1 sm:flex-initial flex items-center justify-center gap-1.5 px-3.5 py-2 rounded-xl bg-purple-50 dark:bg-purple-600/30 hover:bg-purple-100 dark:hover:bg-purple-600 text-purple-700 dark:text-purple-200 dark:hover:text-white font-bold text-xs border border-purple-200 dark:border-purple-500/40 shadow-xs transition-all cursor-pointer"
            ...
            <button
              ...
              className="flex-1 sm:flex-initial flex items-center justify-center gap-1.5 px-3.5 py-2 rounded-xl bg-white hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-700 text-indigo-700 dark:text-indigo-200 hover:text-indigo-900 dark:hover:text-white font-bold text-xs border border-indigo-200 dark:border-indigo-500/30 shadow-xs transition-all cursor-pointer"
        ...
        {isLoading ? (
          ...
          sortedTrainers.map((tr) => {
            ...
            return (
              <div
                key={tr.id}
                className="bg-white dark:bg-slate-850 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 shadow-xs dark:shadow-md backdrop-blur-md flex flex-col justify-between hover:border-indigo-400 dark:hover:border-indigo-500/50 transition-all space-y-3"
              >
                <div>
                  {/* Top info */}
                  <div className="flex items-start justify-between gap-3 mb-2.5">
                    <div className="flex items-center gap-3">
                      {tr.photoUrl ? (
                        ...
                        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 text-white flex items-center justify-center font-bold text-lg shadow-xs shrink-0">
                          {tr.name?.charAt(0) || '?'}
                        </div>
                      )}
                      <div>
                        <div className="flex items-center gap-1.5 flex-wrap">
                          <h3 className="font-bold text-sm text-slate-900 dark:text-slate-100">{tr.name}</h3>
                          {tr.code && (
                            <span className="text-[10px] font-mono font-black px-1.5 py-0.5 rounded-lg bg-blue-50 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-500/40 tracking-wider">
                              {tr.code}
                            </span>
                          )}
                        </div>
                        <p className="text-xs text-amber-700 dark:text-amber-400 font-bold">{tr.specialty}</p>
                        {tr.qualification && (
                          <p className="text-[10px] text-slate-500 dark:text-slate-400 truncate">{tr.qualification}</p>
                        )}
                        <p className="text-[10px] text-slate-500 dark:text-slate-400">{branch?.name || 'الفرع الرئيسي'}</p>
                      </div>
                    </div>
                    <span
                  ...
                  {/* Contact & Extra info */}
                  <div className="space-y-1 text-xs text-slate-700 dark:text-slate-300 bg-slate-50 dark:bg-slate-900/60 p-2.5 rounded-xl border border-slate-200 dark:border-slate-700/60 mb-2.5">
                    ...
                    <div className="flex items-center justify-between pt-1 border-t border-slate-200 dark:border-slate-700 text-[11px]">
                      <span className="text-slate-500 dark:text-slate-400">العمولة:</span>
                  ...
                  <div className="grid grid-cols-3 gap-1.5 text-center text-xs p-2 rounded-xl bg-slate-50 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800 mb-3">
                    <div>
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 block">المستحق</span>
                      <span className="font-bold font-mono text-slate-800 dark:text-slate-200 text-[11px]">{tr.totalEarnings || 0} ج</span>
                    </div>
                    <div className="border-x border-slate-200 dark:border-slate-800">
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 block">المنصرف</span>
                      <span className="font-bold font-mono text-emerald-700 dark:text-emerald-400 text-[11px]">{tr.paidAmount || 0} ج</span>
                    </div>
                    <div>
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 block">المتبقي</span>
                      <span className="font-bold font-mono text-amber-700 dark:text-amber-400 text-[11px]">{tr.remainingDues || 0} ج</span>
                    </div>
                  </div>

                  {/* Dedicated Portal Action Buttons & Password Management for this Trainer */}
                  <div className="bg-indigo-50/70 dark:bg-indigo-950/40 border border-indigo-200 dark:border-indigo-500/30 p-2.5 rounded-xl space-y-2 mb-2">
                    <div className="flex items-center justify-between gap-1 text-[11px] font-bold text-indigo-900 dark:text-indigo-300">
                      ...
                      <button
                        ...
                        className="text-[10px] bg-amber-100 dark:bg-amber-500/20 hover:bg-amber-200 dark:hover:bg-amber-500/30 text-amber-800 dark:text-amber-300 border border-amber-300 dark:border-amber-500/40 px-2 py-0.5 rounded-lg flex items-center gap-1 transition-all cursor-pointer"
                    ...
                    <div className="grid grid-cols-2 gap-1.5">
                      <button
                        ...
                        className="flex items-center justify-center gap-1 py-1.5 px-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-[11px] transition-all shadow-xs cursor-pointer"
                      ...
                      <button
                        ...
                        className="flex items-center justify-center gap-1 py-1.5 px-2 rounded-lg bg-white hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-700 text-indigo-700 dark:text-indigo-200 font-bold text-[11px] border border-slate-200 dark:border-indigo-500/30 transition-all cursor-pointer"
                      ...
                      <button
                        ...
                        className="flex items-center justify-center gap-1 py-1.5 px-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-[11px] transition-all shadow-xs cursor-pointer"
                      ...
                      <button
                        ...
                        className="flex items-center justify-center gap-1 py-1.5 px-2 rounded-lg bg-amber-100/80 hover:bg-amber-200/80 dark:bg-amber-500/20 dark:hover:bg-amber-500/30 text-amber-800 dark:text-amber-300 font-bold text-[11px] border border-amber-300 dark:border-amber-500/30 transition-all cursor-pointer"
                ...
                <div className="flex items-center gap-1.5 pt-2 border-t border-slate-200 dark:border-slate-700/60">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-1 py-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs transition-colors shadow-xs cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-xl bg-indigo-50 hover:bg-indigo-100 dark:bg-indigo-600/20 dark:hover:bg-indigo-600/30 text-indigo-700 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-500/30 transition-colors cursor-pointer"
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-xl bg-amber-50 hover:bg-amber-100 dark:bg-amber-500/20 dark:hover:bg-amber-500/30 text-amber-800 dark:text-amber-300 border border-amber-200 dark:border-amber-500/30 transition-colors cursor-pointer"
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600 text-slate-700 dark:text-amber-300 border border-slate-200 dark:border-transparent transition-colors cursor-pointer"
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600 text-blue-700 dark:text-blue-300 border border-slate-200 dark:border-transparent transition-colors cursor-pointer"
