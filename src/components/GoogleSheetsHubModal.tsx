...
export const GoogleSheetsHubModal: React.FC<GoogleSheetsHubModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/75 backdrop-blur-sm animate-fadeIn" dir="rtl">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700/80 rounded-2xl w-full max-w-4xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden text-slate-900 dark:text-slate-100">
        {/* Header */}
        <div className="p-5 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between bg-slate-50 dark:bg-slate-900/90">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-lg text-slate-900 dark:text-white">مركز التكامل مع Google Sheets™</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400">المزامنة السحابية والتصدير المباشر للجداول وقواعد البيانات</p>
            </div>
          </div>

          <div className="flex items-center gap-2">
            {isConnected ? (
              <div className="flex items-center gap-2 bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-700/50 px-3 py-1.5 rounded-lg text-xs text-emerald-800 dark:text-emerald-300">
                <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
                <span>{connectedUser?.email || 'متصل بـ Google'}</span>
                <button
                  onClick={handleDisconnect}
                  title="قطع الاتصال"
                  className="hover:text-rose-600 dark:hover:text-rose-400 p-1 transition-colors cursor-pointer"
                >
              ...
              <button
                ...
                className="flex items-center gap-1.5 bg-emerald-600 hover:bg-emerald-500 text-white px-3 py-1.5 rounded-lg text-xs font-bold transition-all shadow-md cursor-pointer"
              >
        ...
        {/* Navigation Tabs */}
        <div className="flex border-b border-slate-200 dark:border-slate-800 px-5 bg-slate-50/60 dark:bg-slate-900/50">
          <button
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-6 custom-scrollbar">
          {error && (
            <div className="p-3.5 bg-rose-50 dark:bg-rose-950/50 border border-rose-200 dark:border-rose-800/80 rounded-xl text-rose-700 dark:text-rose-300 text-xs flex items-center gap-2">
          ...
          {actionSuccess && (
            <div className="p-4 bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-700/60 rounded-xl text-emerald-800 dark:text-emerald-200 text-xs flex items-center justify-between gap-2">
              <div className="flex items-center gap-2">
          ...
          {activeTab === 'export' && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {/* Export Trainees */}
                <div className="p-4 bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-xl hover:border-slate-300 dark:hover:border-slate-600 transition-all flex flex-col justify-between">
                  ...
                  <button
                    ...
                    className="mt-4 flex items-center justify-center gap-2 w-full bg-slate-100 hover:bg-emerald-600 hover:text-white dark:bg-slate-700 dark:hover:bg-emerald-600 text-slate-800 dark:text-white text-xs font-bold py-2.5 rounded-lg transition-colors cursor-pointer"
                  >
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-xl hover:border-slate-300 dark:hover:border-slate-600 transition-all flex flex-col justify-between">
                  ...
                  <button
                    ...
                    disabled={isExporting !== null}
                    className="mt-4 flex items-center justify-center gap-2 w-full bg-slate-100 hover:bg-amber-600 hover:text-white dark:bg-slate-700 dark:hover:bg-amber-600 text-slate-800 dark:text-white text-xs font-bold py-2.5 rounded-lg transition-colors cursor-pointer"
                  >
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-xl hover:border-slate-300 dark:hover:border-slate-600 transition-all flex flex-col justify-between">
                  ...
                  <button
                    ...
                    disabled={isExporting !== null}
                    className="mt-4 flex items-center justify-center gap-2 w-full bg-slate-100 hover:bg-sky-600 hover:text-white dark:bg-slate-700 dark:hover:bg-sky-600 text-slate-800 dark:text-white text-xs font-bold py-2.5 rounded-lg transition-colors cursor-pointer"
                  >
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-xl hover:border-slate-300 dark:hover:border-slate-600 transition-all flex flex-col justify-between">
                  ...
                  <button
                    ...
                    disabled={isExporting !== null}
                    className="mt-4 flex items-center justify-center gap-2 w-full bg-slate-100 hover:bg-purple-600 hover:text-white dark:bg-slate-700 dark:hover:bg-purple-600 text-slate-800 dark:text-white text-xs font-bold py-2.5 rounded-lg transition-colors cursor-pointer"
                  >
              ...
              <div className="p-5 bg-gradient-to-r from-emerald-50 via-slate-50 to-cyan-50 dark:from-emerald-950/40 dark:via-slate-800/60 dark:to-cyan-950/40 border border-emerald-200 dark:border-emerald-700/50 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4 mt-6">
                <div>
                ...
                <button
                  ...
                  disabled={isExporting !== null}
                  className="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs rounded-xl shadow-lg transition-all flex items-center gap-2 shrink-0 cursor-pointer"
                >
          ...
          {activeTab === 'import' && (
            <div className="space-y-4">
              <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-200 dark:border-slate-700 space-y-3">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  <input
                    ...
                    className="flex-1 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg px-3 py-2 text-xs text-slate-900 dark:text-slate-100 focus:outline-none focus:border-emerald-500"
                  />
                  <input
                    type="text"
                    value={importRange}
                    ...
                    placeholder="A1:Z100"
                    title="النطاق (Range)"
                    className="w-full sm:w-28 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg px-3 py-2 text-xs text-slate-900 dark:text-slate-100 focus:outline-none focus:border-emerald-500 text-center"
                  />
                  <button
                    onClick={handleFetchImportPreview}
                    disabled={isImporting}
                    className="bg-emerald-600 hover:bg-emerald-500 text-white px-4 py-2 rounded-lg text-xs font-bold flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
                  >
              ...
              {importedPreview && (
                <div className="space-y-2">
                  <h4 className="text-xs font-bold text-slate-800 dark:text-slate-300">معاينة البيانات المستخرجة ({importedPreview.length} صف):</h4>
                  <div className="max-h-64 overflow-auto border border-slate-200 dark:border-slate-700 rounded-xl bg-white dark:bg-slate-950">
                    <table className="w-full text-xs text-right text-slate-800 dark:text-slate-300 border-collapse">
                      <tbody>
                        {importedPreview.map((row, rIdx) => (
                          <tr key={rIdx} className={rIdx === 0 ? 'bg-slate-100 dark:bg-slate-800/80 font-bold text-slate-900 dark:text-slate-100 border-b border-slate-200 dark:border-slate-700' : 'border-b border-slate-100 dark:border-slate-800/40 hover:bg-slate-50 dark:hover:bg-slate-900'}>
                            {row.map((cell, cIdx) => (
                              <td key={cIdx} className="p-2 border-l border-slate-100 dark:border-slate-800/40 truncate max-w-xs">
                                {cell}
                              </td>
                            ))}
                          </tr>
          ...
          {activeTab === 'sheets' && (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-xs text-slate-500 dark:text-slate-400">الجداول المتزامنة والمنشأة من النظام:</span>
                <button
                  onClick={loadUserSheets}
                  disabled={isLoadingSheets}
                  className="flex items-center gap-1 text-xs text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 cursor-pointer"
                >
              ...
              <div className="space-y-2 max-h-80 overflow-y-auto">
                {sheetsList.length === 0 ? (
                  ...
                  sheetsList.map((sheet, idx) => (
                    <div
                      key={sheet.id || idx}
                      className="p-3 bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700/60 rounded-xl flex items-center justify-between hover:bg-white dark:hover:bg-slate-800 transition-colors"
                    >
                      <div className="flex items-center gap-3">
                        <FileSpreadsheet className="w-5 h-5 text-emerald-600 dark:text-emerald-400 shrink-0" />
                        <div>
                          <p className="text-xs font-bold text-slate-900 dark:text-slate-200">{sheet.name}</p>
                          {sheet.modifiedTime && (
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="flex items-center gap-1 text-xs text-emerald-700 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 px-3 py-1.5 rounded-lg bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800/40 transition-colors"
                      >
                        <ExternalLink className="w-3.5 h-3.5" />
                        فتح الجدول
                      </a>
