...
export const HomeworkSubmissionRepo = createRepo<any>('homeworkSubmissions');
export const BadgeRepo = createRepo<any>('badges');
export const AssignmentRepo = createRepo<AssignmentTask>('assignments');
export const ScheduleRepo = createRepo<any>('schedules');
export const LabScheduleRepo = createRepo<any>('labSchedules');
export const PortalMessageRepo = createRepo<any>('portalMessages');
